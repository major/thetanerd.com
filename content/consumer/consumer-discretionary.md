---
title: "🛍️ Consumer Discretionary ETFs"
description: "Comparing XLY, VCR, and FDIS — the core consumer discretionary ETFs, plus equal-weight alternatives for diversified exposure"
---
...
```mermaid
flowchart TD
    A[**Consumer Discretionary ETFs**] --> B[AMZN + TSLA = ~40%]
    B --> C[Top 10 Holdings = ~60%]
    C --> D[Remaining 40-290 stocks = ~40%]
    
    B -.- E[High single-stock risk]
    D -.- F[Limited diversification benefit]
```
...
|-----|------|---------|----------|
| {{< badge content="XLY" color="blue" >}} | Core | 0.09% | Trading, options, liquidity |
| {{< badge content="VCR" color="blue" >}} | Core | 0.10% | Broad diversification |
| {{< badge content="FDIS" color="green" >}} | Core | 0.08% | Lowest cost long-term holding |
| {{< badge content="RSPD" color="yellow" >}} | Equal-Weight | 0.40% | Reduce concentration, breadth bet |
| {{< badge content="WANT" color="red" >}} | Leveraged | 0.97% | 3x bull, short-term only |
| {{< badge content="PASS" color="red" >}} | Leveraged | 1.01% | 3x bear, short-term only |
...
{{% details title="Equal-weight methodology" closed="true" %}}
...
{{% details title="Sector classification" closed="true" %}}
