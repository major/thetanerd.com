...
Roughly **50% of silver demand is industrial** (electronics, solar panels, EVs, medical devices) while the other **50% is investment/monetary** (bars, coins, jewelry, silverware). This creates a metal that can rally on fear *or* greed — and sometimes both at once.
...
- **Solar panels**: Each panel uses [~20 grams of silver](https://www.silverinstitute.org/silver-solar-energy/) for its photovoltaic cells
- **EVs**: Electric vehicles use [25-50 grams of silver](https://www.silverinstitute.org/silver-automotive-sector/) (2x more than ICE vehicles)
...
The electrification megatrend is **bullish for silver's industrial side** — the same story driving copper applies here.
...
- Mexico, China, and Peru account for [~48% of global mine production](https://pubs.usgs.gov/periodicals/mcs2025/mcs2025-silver.pdf)
- Primary silver mines are relatively rare — most silver comes incidentally
...
For traders, this volatility is a feature, not a bug — if you can read the signals.
...
|-----|------|----------------|------------------|
| [**SLV**](https://www.ishares.com/us/products/239855/ishares-silver-trust) | iShares Silver Trust | Physical silver | Pure commodity exposure |
| [**PSLV**](https://sprott.com/investment-strategies/physical-bullion-trusts/silver/) | Sprott Physical Silver Trust | Physical silver (allocated) | Alternative physical exposure |
| [**SIL**](https://www.globalxetfs.com/funds/sil/) | Global X Silver Miners ETF | Silver mining companies | Equity leverage to silver |
| [**SILJ**](https://www.amplifyetfs.com/silj) | Amplify Junior Silver Miners ETF | Junior silver miners | High-beta miner exposure |

### Related Metals & Context

| ETF | Name | What It Tracks | Role in Analysis |
|-----|------|----------------|------------------|
| [**GLD**](https://www.ssga.com/us/en/individual/etfs/spdr-gold-shares-gld) | SPDR Gold Shares | Physical gold | Precious metals leadership |
| [**GDX**](https://www.vaneck.com/us/en/investments/gold-miners-etf-gdx/) | VanEck Gold Miners ETF | Gold miners | Equity sentiment comparison |
| [**COPX**](https://www.globalxetfs.com/funds/copx/) | Global X Copper Miners ETF | Copper miners | Industrial demand signal |
...
COPX and CPER break out first — industrial demand thesis gains traction.
...
GLD underperforms SLV — the gold/silver ratio compresses.
...
GLD and GDX break out first — flight to safety trade.
...
Industrial metals underperform — this is a fear trade, not growth.
...
#### SLV/GLD — Silver vs. Gold (The Gold/Silver Ratio Inverse)
This is the **critical ratio** for understanding which personality is dominant:

- **SLV/GLD rising**: Silver outperforming gold — risk appetite strong, industrial bid present
- **SLV/GLD falling**: Gold outperforming silver — fear trade dominant, silver's industrial half is a drag

#### SIL/SLV — Miners vs. Commodity
- **Rising**: Miners leading — equity investors positioning ahead of the commodity
- **Falling**: Commodity leading — late-cycle or miners facing cost pressures

#### SLV/SPY — Silver vs. Market
- **Rising**: Silver outperforming equities — precious metals bid
- **Falling**: Risk-on mode leaving silver behind

#### SIL/GDX — Silver Miners vs. Gold Miners
- **Rising**: Silver beta outperforming — risk appetite favors silver's industrial side
- **Falling**: Flight to quality within precious metals — gold preferred
...
|-----------|----------------|
| SLV/GLD rising, SIL/SLV rising | Industrial bull — risk-on silver trade |
| SLV/GLD rising, SLV/SPY rising | Full precious rally with silver leadership |
| SLV/GLD falling, GLD/SPY rising | Gold leading — defensive positioning |
| SLV/GLD falling, GLD/SPY falling | No bid for precious — risk-on without metals |

## How do I know where we are in the cycle?

{{< tabs items="Beginning,Middle,End" >}}

{{< tab >}}

{{< callout type="info" >}}
**Key signal**: SIL breaking out while SLV consolidates, or GLD leading with SLV following
{{< /callout >}}
...
**Confirmation phase**: Both commodity and miners participating
{{< /callout >}}
...
The gold/silver ratio (gold price ÷ silver price) is one of the most useful signals in precious metals:

| Ratio Level | Historical Context | Signal |
|-------------|-------------------|--------|
| **100:1+** | Extreme fear, silver abandoned | Silver historically cheap — contrarian long |
| **80-100:1** | Elevated, gold preferred | Silver undervalued, watch for reversal |
| **60-80:1** | Normal range | Neutral — trade other signals |
| **50-60:1** | Silver outperformance | Getting extended — silver may be peaking |
| **<50:1** | Rare, last seen 2011 | Extreme — silver likely overextended |

### How to use it:

1. **At ratio extremes (90+)**: Look for silver entry signals. The ratio tends to mean-revert.
2. **Ratio compressing rapidly**: Silver is working. Let it run but tighten stops.
3. **Ratio at lows (<60)**: Consider taking profits or hedging. Silver reverts hard.

## How do I put this all together?

### Daily Checklist

1. **Check SLV/GLD ratio** — Is silver leading or lagging gold?
2. **Check SIL/SLV ratio** — Are miners leading or lagging?
3. **Identify the driver** — Is this industrial (watch copper) or fear (watch gold)?
4. **Check the gold/silver ratio** — Where are we historically?
5. **News scan** — WallStreetBets activity? Magazine covers? Contrarian when crowded.
...
|-------|---------------|------------------|
| {{< badge content="Early" color="blue" >}} | SIL leads, G/S ratio 90+, driver emerging | Smart money positioning |
| {{< badge content="Middle" color="yellow" >}} | Both participating, ratio compressing | Trend confirmation |
| {{< badge content="Late" color="red" >}} | SLV leads SIL, ratio <60, retail frenzy | Exhaustion approaching |
...
- **Byproduct production**: USGS Mineral Commodity Summaries 2025, "[Silver](https://pubs.usgs.gov/periodicals/mcs2025/mcs2025-silver.pdf)". Approximately 70% of silver comes as byproduct from lead-zinc, copper, and gold mining.

- **Geographic concentration**: USGS data shows Mexico (24%), China (13%), and Peru (11%) account for ~48% of global mine production.

- **Solar panel usage**: The Silver Institute, "[Silver in Solar Energy](https://www.silverinstitute.org/silver-solar-energy/)". Solar PV demand has grown from ~50 Moz in 2014 to ~160+ Moz.

- **EV silver content**: The Silver Institute, "[Silver in the Automotive Sector](https://www.silverinstitute.org/silver-automotive-sector/)". EVs use significantly more silver than ICE vehicles.
...
- **2020-2021 move**: Silver moved from $11.77 (March 2020 low) to $30+ (February 2021) — a 155%+ move.
...
- **SIL**: [Global X ETFs](https://www.globalxetfs.com/funds/sil/) — tracks Solactive Global Silver Miners Index
- **SILJ**: [Amplify ETFs](https://www.amplifyetfs.com/silj) — junior silver miners, higher beta
- **GLD**: [State Street Global Advisors](https://www.ssga.com/us/en/individual/etfs/spdr-gold-shares-gld) — largest gold ETF
- **GDX**: [VanEck](https://www.vaneck.com/us/en/investments/gold-miners-etf-gdx/) — gold miners ETF
...
- **LBMA**: [London Bullion Market Association](https://www.lbma.org.uk/) — silver price benchmarking and market data
