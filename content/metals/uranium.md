...
- **Production cuts**: [Kazakhstan (40% of global supply)](https://world-nuclear.org/information-library/nuclear-fuel-cycle/mining-of-uranium/world-uranium-mining-production) cut production 17% in 2024 and announced further cuts for 2025-2026
...
- **AI data centers**: [Microsoft, Google, Amazon](https://www.reuters.com/business/energy/big-tech-turns-nuclear-power-ai-energy-fix-2024-10-21/) are all signing nuclear deals for 24/7 carbon-free power
- **China building 6-8 reactors per year** with plans to [triple nuclear capacity by 2035](https://world-nuclear.org/information-library/country-profiles/countries-a-f/china-nuclear-power)
...
1. **Mining equities** (most volatile, equity risk + commodity risk)
2. **Physical trusts** (Sprott's SRUUF holds actual uranium)
3. **ETFs** (baskets mixing miners, physical, and nuclear-adjacent companies)
...
|-----|------|----------------|------------------|
| [**URA**](https://www.globalxetfs.com/funds/ura/) | Global X Uranium ETF | Uranium miners + nuclear components | Broadest exposure, most liquid |
| [**URNM**](https://www.sprottusa.com/etfs-update/urnm-sprott-uranium-miners-etf/) | Sprott Uranium Miners ETF | Pure uranium miners + physical uranium | Highest beta, concentrated |
| [**NLR**](https://www.vaneck.com/us/en/investments/uranium-nuclear-energy-etf-nlr/) | VanEck Uranium and Nuclear ETF | Broad nuclear value chain | Includes utilities, lowest cost |
| [**NUKZ**](https://www.nukz.rangeetfs.com/) | Range Nuclear Renaissance ETF | Balanced fuel cycle + SMR exposure | Newest, innovation-focused |
...
| ETF | Name | What It Tracks | Role in Analysis |
|-----|------|----------------|------------------|
| [**XLE**](https://www.ssga.com/us/en/individual/etfs/the-energy-select-sector-spdr-fund-xle) | Energy Select Sector SPDR | Traditional energy | Sector rotation signal |
| [**ICLN**](https://www.ishares.com/us/products/239738/ishares-global-clean-energy-etf) | iShares Global Clean Energy ETF | Renewables | Green energy sentiment |
...
- [0.75% expense ratio](https://www.sprottusa.com/etfs-update/urnm-sprott-uranium-miners-etf/)

#### URA — The Diversified Leader
- **49 holdings** — most diversified
- **~$6.5 billion AUM** — [most liquid](https://www.globalxetfs.com/funds/ura/)
...
- [0.69% expense ratio](https://www.globalxetfs.com/funds/ura/)
...
- [0.85% expense ratio](https://www.nukz.rangeetfs.com/)
...
- **Lowest expense ratio at 0.56%** — [cheapest way to play nuclear](https://www.vaneck.com/us/en/investments/uranium-nuclear-energy-etf-nlr/)
...
1. **Sprott's buying power**: When Sprott Physical Uranium Trust raises capital, it buys physical uranium, directly lifting spot prices
2. **No futures arbitrage**: Without liquid futures, there's no mechanism to short overextended moves
3. **Utility contracting**: Spot represents only ~15-20% of uranium transactions; term contracts are the real market
4. **Psychology**: Spot price movements signal to utilities and miners alike
...
{{< callout type="info" >}}
**Key signal**: Physical uranium (SRUUF) breaking out, URNM starting to outperform URA
{{< /callout >}}
...
**Confirmation phase**: Miners catching up to physical, broad participation
{{< /callout >}}
...
1. **Check URNM/URA ratio** — Is pure uranium leading or lagging diversified?
2. **Check URA/SPY** — Is nuclear theme outperforming the market?
3. **Check spot uranium** — Is physical leading the miners?
4. **Check NLR/URA** — Are utilities leading (defensive) or lagging (risk-on)?
5. **News scan** — Policy changes? Utility contracts? Contrarian when crowded.
...
|-------|---------------|------------------|
| {{< badge content="Early" color="blue" >}} | Physical leads, URNM/URA bottoming, low attention | Smart money accumulating |
| {{< badge content="Middle" color="yellow" >}} | Miners catching up, broad participation, media interest | Trend confirmation |
| {{< badge content="Late" color="red" >}} | Juniors leading, SMR hype, NLR outperforms, crowded | Exhaustion approaching |
...
- **Reactors under construction**: World Nuclear Association tracks [50+ reactors currently under construction](https://world-nuclear.org/information-library/current-and-future-generation/plans-for-new-reactors-worldwide) globally.

- **Tech company nuclear deals**: Reuters, "[Big Tech turns to nuclear power for AI energy fix](https://www.reuters.com/business/energy/big-tech-turns-nuclear-power-ai-energy-fix-2024-10-21/)" (October 2024). Microsoft, Google, and Amazon all announced nuclear power agreements.

- **China nuclear expansion**: World Nuclear Association, "[Nuclear Power in China](https://world-nuclear.org/information-library/country-profiles/countries-a-f/china-nuclear-power)". Plans to triple capacity by 2035 with 6-8 reactors under construction annually.
...
- **URNM**: [Sprott Asset Management](https://www.sprottusa.com/etfs-update/urnm-sprott-uranium-miners-etf/) — ~$2.0B AUM, 26 holdings, 0.75% expense ratio (reduced from 0.85% in April 2024). Requires 50%+ revenue from uranium mining.

- **NLR**: [VanEck](https://www.vaneck.com/us/en/investments/uranium-nuclear-energy-etf-nlr/) — ~$3.0B AUM, 29 holdings, 0.56% expense ratio (lowest). Oldest uranium ETF (2007 inception).

- **NUKZ**: [Range ETFs](https://www.nukz.rangeetfs.com/) — ~$750M AUM, 51 holdings, 0.85% expense ratio. Launched January 2024, focuses on nuclear renaissance including SMR technology.

- **SRUUF**: [Sprott Physical Uranium Trust](https://sprott.com/investment-strategies/physical-commodity-funds/uranium/) — holds physical uranium (U₃O₈) in storage. Pure commodity exposure.
...
- **Sprott**: [sprott.com](https://sprott.com/) — physical uranium market commentary and trust NAV data.
