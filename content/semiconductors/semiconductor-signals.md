...
Semiconductors aren't monolithic — different segments respond differently to economic conditions:
...
### SMH/SPY — Semiconductors vs. Market
...
### SMH/QQQ — Semiconductors vs. Tech
...
### XSD/SMH — Small-Cap vs. Mega-Cap Semis

The **key ratio** for measuring semiconductor market breadth:

| XSD/SMH Behavior | Condition | Action |
|------------------|-----------|--------|
| Rising | Breadth expanding | Small-caps participating — healthy rally |
| Falling | Narrow leadership | Mega-caps only — watch for exhaustion |
...
### SOXX/XLK — Semiconductors vs. Broad Tech
...
### SMH/XLI — Semiconductors vs. Industrials
...
### SMH/GLD — Semiconductors vs. Gold
...
### SMH/TLT — Semiconductors vs. Long Bonds
...
|------------|--------|-----------------|
| TSMC Monthly Revenue | [TSMC IR](https://investor.tsmc.com/) | Real-time chip demand |
| Memory Spot Pricing | [DRAMeXchange](https://www.dramexchange.com/) | Supply/demand balance |
| Semiconductor Billings | [SIA](https://www.semiconductors.org/) | Industry revenue trends |
...
{{< cards >}}
  {{< card link="../semiconductor-etfs" title="Semiconductor ETFs" subtitle="SMH vs SOXX vs XSD — which one and when?" >}}
  {{< card link="../upstream-materials" title="Upstream Materials" subtitle="Rare earth and lithium — the inputs that make chips possible" >}}
  {{< card link="../downstream-products" title="Downstream Products" subtitle="Data centers, cloud, robotics — where chips go to work" >}}
{{< /cards >}}
...
- **TSMC Revenue**: [TSMC Investor Relations](https://investor.tsmc.com/) — Monthly revenue disclosures.

- **Memory Pricing**: [DRAMeXchange/TrendForce](https://www.dramexchange.com/) — DRAM and NAND spot pricing.

- **Semiconductor Industry Association**: [SIA](https://www.semiconductors.org/) — Monthly billings data, industry reports.

- **World Semiconductor Trade Statistics**: [WSTS](https://www.wsts.org/) — Global semiconductor market data.

{{% /details %}}

{{% details title="ETF information" closed="true" %}}

- **SMH**: [VanEck](https://www.vaneck.com/us/en/investments/semiconductor-etf-smh/) — Market-cap weighted, mega-cap focus
- **SOXX**: [iShares](https://www.ishares.com/us/products/239705/ishares-phlx-semiconductor-etf) — Modified cap-weighted, capped positions
- **XSD**: [State Street](https://www.ssga.com/us/en/intermediary/etfs/spdr-sp-semiconductor-etf-xsd) — Equal-weighted, small-cap tilt
- **XLK**: [State Street](https://www.ssga.com/us/en/intermediary/etfs/the-technology-select-sector-spdr-fund-xlk) — Technology Select Sector
