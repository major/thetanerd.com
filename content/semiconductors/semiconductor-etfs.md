...
|-----|------|---------|----------|
| {{< badge content="SMH" color="blue" >}} | Core | 0.35% | Mega-cap AI/chip exposure |
| {{< badge content="SOXX" color="blue" >}} | Core | 0.35% | Balanced large-cap |
| {{< badge content="XSD" color="blue" >}} | Core | 0.35% | Small-cap, high-beta |
| {{< badge content="SOXQ" color="green" >}} | Alternative | 0.19% | Low-cost SOXX alternative |
| {{< badge content="PSI" color="green" >}} | Alternative | 0.56% | Factor-based selection |
| {{< badge content="SOXL" color="red" >}} | Leveraged | 0.75% | 3x bull, short-term |
| {{< badge content="SOXS" color="red" >}} | Leveraged | 0.97% | 3x bear, short-term |
| {{< badge content="USD" color="yellow" >}} | Leveraged | 0.95% | 2x bull, swing trades |
| {{< badge content="SSG" color="yellow" >}} | Leveraged | 0.95% | 2x bear, swing trades |
...
{{% details title="Leveraged ETF information" closed="true" %}}
...
{{% details title="Volatility decay and leveraged ETF mechanics" closed="true" %}}
