...
### DTCR — The Data Center Play

| Attribute | Details |
|-----------|---------|
| **ETF** | [DTCR](https://www.globalxetfs.com/funds/dtcr/) |
...
Cloud computing sits between physical infrastructure and end applications. The hyperscalers (AWS, Azure, GCP) are the **largest semiconductor customers** — their capex directly drives chip demand.

### CLOU — The Cloud Computing ETF

| Attribute | Details |
|-----------|---------|
| **ETF** | [CLOU](https://www.globalxetfs.com/funds/clou/) |
...
### WCLD — The Pure SaaS Play

| Attribute | Details |
|-----------|---------|
| **ETF** | [WCLD](https://www.wisdomtree.com/investments/etfs/equity/wcld) |
...
| **Google** | GCP | TPU/GPU investments |
...
### BOTZ — The Robotics ETF

| Attribute | Details |
|-----------|---------|
| **ETF** | [BOTZ](https://www.globalxetfs.com/funds/botz/) |
...
### ROBO — The Broader Automation Play

| Attribute | Details |
|-----------|---------|
| **ETF** | [ROBO](https://www.intlalpha.com/robo/) |
...
### ARKQ — The Disruptive Automation Play

| Attribute | Details |
|-----------|---------|
| **ETF** | [ARKQ](https://ark-funds.com/funds/arkq/) |
...
**Healthy semiconductor rally**: All downstream segments participating
**Suspicious rally**: Chips up, downstream flat (demand not confirmed)

### Key Ratios to Monitor

| Ratio | What It Tells You |
|-------|-------------------|
| **DTCR/SMH** | Data centers vs. chips — infrastructure catch-up |
| **CLOU/SMH** | Cloud vs. chips — software vs. hardware |
| **BOTZ/SMH** | Robotics vs. chips — automation cycle |
| **CLOU/QQQ** | Cloud vs. tech — sector rotation |
...
|-----|-------|---------|-------------------|----------|
| {{< badge content="DTCR" color="blue" >}} | Data centers | 0.50% | Lower | Infrastructure play, income |
| {{< badge content="CLOU" color="green" >}} | Cloud computing | 0.68% | Moderate | Broad cloud exposure |
| {{< badge content="WCLD" color="green" >}} | Pure SaaS | 0.45% | Moderate | Small-cap SaaS |
| {{< badge content="BOTZ" color="yellow" >}} | Robotics/AI | 0.68% | Moderate | Industrial automation |
| {{< badge content="ROBO" color="yellow" >}} | Broad automation | 0.95% | Moderate | Diversified robotics |
| {{< badge content="ARKQ" color="red" >}} | Disruptive automation | 0.75% | Variable | High-conviction active |
...
- **DTCR**: [Global X](https://www.globalxetfs.com/funds/dtcr/) — Tracks Solactive Data Center REITs & Digital Infrastructure Index
...
{{% details title="Cloud computing ETF information" closed="true" %}}

- **CLOU**: [Global X](https://www.globalxetfs.com/funds/clou/) — Tracks Indxx Global Cloud Computing Index

- **WCLD**: [WisdomTree](https://www.wisdomtree.com/investments/etfs/equity/wcld) — Tracks BVP Nasdaq Emerging Cloud Index
...
{{% details title="Robotics ETF information" closed="true" %}}

- **BOTZ**: [Global X](https://www.globalxetfs.com/funds/botz/) — Tracks Indxx Global Robotics & Artificial Intelligence Index

- **ROBO**: [Robo Global](https://www.intlalpha.com/robo/) — Tracks Robo Global Robotics and Automation Index

- **ARKQ**: [ARK Invest](https://ark-funds.com/funds/arkq/) — Actively managed autonomous technology fund
