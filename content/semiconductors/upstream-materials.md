...
|-----|-------|---------|------------|----------|
| {{< badge content="REMX" color="blue" >}} | Rare earth/strategic metals | 0.56% | High | Pure rare earth exposure |
| {{< badge content="LIT" color="green" >}} | Lithium + batteries | 0.75% | Moderate-High | Concentrated lithium bet |
| {{< badge content="BATT" color="green" >}} | Broad battery tech | 0.59% | Moderate | Diversified battery exposure |
| {{< badge content="DRIV" color="yellow" >}} | EVs + supply chain | 0.68% | Moderate | EV ecosystem play |
...
{{% details title="Rare earth and lithium fundamentals" closed="true" %}}
...
{{% details title="Geopolitical context" closed="true" %}}
