...
summary: >-
  Let's talk about what technical analysis is and what it isn't.
  Be sure you're using it for the right reasons. 🤔
tags:
  - analysis
  - strategy
coverAlt: Compass on top of a map
coverCaption: |
  [Alexander Andrews](https://unsplash.com/photos/black-and-gray-compass-on-top-of-map-4JdvOwrVzfY)
  via Unsplash
---

In my post earlier this month about my [trading changes for 2024](/p/my-trading-changes-for-2024/), I noted that one part of my "reset" was around cleaning up my charts. I buried myself in all kinds of indicators over time, some paid and some free, but my win percentage and gains didn't change. I tried various services to get an edge on the options market, but yet that didn't change anything either.
...
{{< figure
    src="best-loser-wins-assume-wrong.png"
    alt="Quote from _Best Loser Wins_"
    caption="Quote from _Best Loser Wins_"
    >}}
